...
public class LogInPage extends JFrame {
	...
	public LogInPage() {
		...
		passwordField.setBounds(134, 164, 128, 20);
		...
		btnSignIn.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				System.out.println("Sign in left button clicked!");
				contentPane.repaint();
		...
		btnSignIn2.addActionListener(e -> {
			System.out.println("button clicked!");
			System.out.println(txtPasswordSignIn.getText());
			
			if (txtNameSignIn.getText().equals(username) && txtPasswordSignIn.getText().equals(password)) {
